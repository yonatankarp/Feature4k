...
class LoggerTest {
    ...
    @Test
    fun `logger debug does not throw`() = runTest {
        val log = logger("TestLogger")
        log.debug("Debug message")
    }

    @Test
    fun `logger info does not throw`() = runTest {
        val log = logger("TestLogger")
        log.info("Info message")
    }

    @Test
    fun `logger warn does not throw`() = runTest {
        val log = logger("TestLogger")
        log.warn("Warning message")
    }

    @Test
    fun `logger error does not throw`() = runTest {
        val log = logger("TestLogger")
        log.error("Error message")
    }

    @Test
    fun `logger error with throwable does not throw`() = runTest {
        val log = logger("TestLogger")
