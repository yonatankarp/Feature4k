...
/**
 * A flipping strategy that enables a feature only for users in an explicit whitelist.
 *
 ...
 * whitelist, the strategy evaluates to `false`.
 *
 * ## Use Cases
 *
