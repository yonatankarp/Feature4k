 ...
 * )
 *
 * val result = feature.evaluate(FlippingExecutionContext.empty()) // returns true (overrides enabled)
 * ```
 *
...
data object AlwaysOnStrategy : FlippingStrategy {
    override fun evaluate(context: FlippingExecutionContext): Boolean = true
}
