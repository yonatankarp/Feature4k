...
/**
 * Channel-based implementation of [com.yonatankarp.feature4k.event.EventBus] for auditing scenarios.
 *
 * This implementation uses an unbounded channel with non-blocking sends via [kotlinx.coroutines.channels.Channel.trySend].
 ...
 * - You want to avoid blocking operations if consumers are slow
 *
 * @param T The type of events this bus handles
 * @author Yonatan Karp-Rudin
 */
class ChannelEventBus<T> : EventBus<T> {
    private val channel = Channel<T>(Channel.UNLIMITED)
    private val logger = logger("ChannelEventBus")
