 ...
 * if (feature4k.check("new-dashboard")) {
 *     // Show new dashboard
 * }
 * ```
 *
...
class Feature4K(
     ...
     */
    suspend fun property(propertyName: String): Property<*> = propertyStore[propertyName] ?: throw PropertyNotFoundException(propertyName)
