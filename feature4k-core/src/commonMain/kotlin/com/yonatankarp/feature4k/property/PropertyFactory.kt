...
object PropertyFactory {
     ...
     * @param fixedValues Optional set of allowed integer values; an empty set indicates no restriction.
     ...
     *
     * @param description Optional human-readable description for the property.
     * @param fixedValues Optional set of allowed Instant values for the property.
     * @param readOnly Whether the property is read-only and cannot be modified.
